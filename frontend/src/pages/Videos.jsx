        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="w-full md:w-48">
            <Select
              ...
              onChange={(e) => setFilters({ ...filters, transcription_status: e.target.value })}
          ...
          {/* Clear filters */}
          {(filters.status || filters.transcription_status || filters.search) && (
            <Button
              variant="ghost"
              onClick={() => setFilters({ status: '', transcription_status: '', search: '' })}
            >
              Clear
            </Button>
          )}
